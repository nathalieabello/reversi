 ...
 */
public abstract class AbstractSquareStrategyTests extends AbstractModelStrategyTests {
  ...
  public void init() {
    ...
    this.actionableModel = new SquareReversiModel.SquareBuilder().setLayers(3).build();
  ...
  public void testMoveReturnsEmptyOptionalIfNoPossibleMoves() {
    ...
    System.out.println(new SquareReversiTextualView(actionableModel));
